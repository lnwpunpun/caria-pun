...
const en = {
  ...
  assessment: {
    ...
    title: "Detailed 10-Question Assessment (Demo)",
    ...
    section: "Sample 3 of 10 Questions",
    questionsCount: "10 Questions Pool",
    disagree: "Disagree",
    agree: "Agree",
    saveAndContinue: "Click here to start the real assessment (10 Questions) →",
...
const th: typeof en = {
  ...
  assessment: {
    ...
    title: "แบบประเมินสมรรถนะ 10 ข้อ (ฉบับทดลอง)",
    ...
    section: "ตัวอย่าง 3 จาก 10 ข้อ",
    questionsCount: "คลังคำถาม 10 ข้อ",
    disagree: "ไม่เห็นด้วย",
    agree: "เห็นด้วย",
    saveAndContinue: "คลิกตรงนี้เพื่อเริ่มทำแบบประเมินจริง (10 ข้อ) →",
